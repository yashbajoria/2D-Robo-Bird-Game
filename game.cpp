...
glColor3f(1.0,1.0,1.0);
renderBitmapString(35,85,0,GLUT_BITMAP_HELVETICA_18,"National Institute of Technology");

renderBitmapString(45,80,0,GLUT_BITMAP_HELVETICA_12,"Silchar, Assam");

glColor3f(0,0,1.0);
renderBitmapString(34,65,0,GLUT_BITMAP_8_BY_13,"A Mini kinder game project for CG");
renderBitmapString(40,70,0,GLUT_BITMAP_TIMES_ROMAN_24,"2D Robo bird GAME");

glColor3f(1.0,0.0,0.0);
renderBitmapString(40,45,0,GLUT_BITMAP_TIMES_ROMAN_24,"WELCOME :");
renderBitmapString(60,45,0,GLUT_BITMAP_TIMES_ROMAN_24,name);
...
glutCreateWindow ("Hello 2D Robo bird Game");
init();
